...
object LegacyVictoriaMetricsAppSpec extends MultiVersionVictoriaClientRunnable {

  override val versions: Seq[String] = Seq("v1.42.0")
    ...
    suite("put")(
      testM("Should retrieve the inserted points") {
        ...
        for {
          ...
          exclusiveEnd // adjusting for a bug in earlier Versions of Victoriametrics
        })(
